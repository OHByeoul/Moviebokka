...
<body>
    <div class="container">
            <h2>리뷰 작성</h2>
            <form class="form-horizontal" action="/Moviebokka/movie/updateReview" id = "review_form" method="post">
              ...
              <div class="form-group">
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-8 offset-md-1">          
                            <textarea class="form-control" rows="8" cols="50" placeholder="리뷰 내용" name="content" required>${review.rev_content}</textarea>
                        </div>
                      </div>
            </form>
                  <div class="form-group">        

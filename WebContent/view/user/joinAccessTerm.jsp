...
<body class=body>
   <div align="center">
      <h1 class=subTitle>Moviebokka 이용약관</h1>
      <br>
   
      <form action="/Moviebokka/user/join" name="form" method="post">
            <div class="accessTermBox" >
               <p class="accessTextTitle">제1조(목적)</p>
               본 회원약관은 무비보까(이하 '갑'라 한다)가 운영하는 인터넷관련 서비스(이하 '서비스'라 한다)를 이용함에 있어 
               관리자와 이용자(이하 '회원'라 한다)의 권리, 의무 및 책임사항을 규정함을 목적으로 한다.<br>
               
               <br><p class="accessTextTitle">제2조 (약관의 효력)</p>
               ...
               <br><p class="accessTextTitle">제6조 (이용신청)</p>
               회원 가입은 온라인으로 가입신청 양식에 기록하여 '갑'에 제출함으로써 이용신청을 할 수 있습니다.<br>
               
               <br><p class="accessTextTitle">제7조 (회원가입의 승낙)</p>
               '갑'의 회원 가입 신청 양식에 가입 희망 회원이 인터넷으로 제6조와 같이 신청하면 '갑'은 바로 가입을 승인하여 서비스를 이용할 수 있다.<br>
               
               <br><p class="accessTextTitle">제8조(회원가입 신청거절 및 강제 탈퇴)</p>
               1. '갑'은 타인의 명의를 도용하여 회원가입신청을 할 경우 회원가입신청을 거절할 수 있다.<br>
               2. 회원가입신청이 승인이 된 후에도 허위사실의 기재가 발각되거나 '갑'의 명예를 회손시키거나 음란물이나 불건전한 내용을 게재할 경우 회원의 자격을 강제 탈퇴시킬 수 있다.<br>
               
               <br><p class="accessTextTitle">제9조 (서비스 제공의 중지)</p>
               ...
               <br><p class="accessTextTitle">제10조 ('갑'의 의무)</p>
               ...
               <br><p class="accessTextTitle">제11조 (개인정보보호)</p>
               ...
               <br><p class="accessTextTitle">제12조 (회원의 의무)</p>
               ...
               <br><p class="accessTextTitle">제13조 (게시물 또는 내용물의 삭제) </p>
               '갑'은 서비스의 게시물 또는 내용물이 제12조의 규정에 위반되거나 '갑' 소정의 게시기간을 초과하는 경우 사전 통지나 동의 없이 이를 삭제할 수 있습니다.<br>
               
               <br><p class="accessTextTitle">제14조 (게시물에 대한 권리·의무)</p>
               게시물에 대한 저작권을 포함한 모든 권리 및 책임은 이를 게시한 회원에게 있습니다.
               
               <br><p class="accessTextTitle">제15조 (양도금지)</p>
               회원이 서비스의 이용권한, 기타 이용계약상 지위를 타인에게 양도, 증여할 수 없으며, 이를 담보로 제공할 수 없습니다.<br>
               
               <br><p class="accessTextTitle">제16조 (계약해지 및 이용제한)</p>
               '갑'은 해지 및 탈퇴를 한 회원이 다시 이용신청을 하는 경우 일정기간 그 승낙을 제한할 수 있습니다.<br>
               
               <br><p class="accessTextTitle">제17조 (면책·배상)</p>
               1. '갑'은 회원이 서비스에 게재한 정보, 자료, 사실의 정확성, 신뢰성 등 그 내용에 관하여는 어떠한 책임을 부담하지 아니하고,  회원은 자기의 책임아래 서비스를 이용하며, 
               서비스를 이용하여 게시 또는 전송한 자료 등에 관하여 손해가 발생하거나 자료의 취사 선택, 기타서비스 이용과 관련하여 어떠한 불이익이 발생 하더라도 이에 대한 모든 책임은 회원에게 있습니다.<br>
               2. '갑'은 제12조의 규정에 위반하여 회원간 또는 회원과 제3자간에 서비스를 매개로 하여 물품거래 등과 관련하여 어떠한 책임도 부담하지 아니하고, 
               ...
               4. 회원이 제12조, 기타 이 약관의 규정을 위반함으로 인하여 '갑'이 회원 또는 제3자에 대하여 책임을 부담하게 되고, 이로써 '갑'에게 손해가 발생하게 되는 경우,
                이 약관을 위반한 회원은 '갑'에게  발생하는 모든 손해를 배상하여야 하며, 동 손해로부터 '갑'을 면책시켜야 합니다.<br>
                
               <br><p class="accessTextTitle">제18조 (분쟁의 해결) </p>
               ...
               <br><p class="accessTextTitle" align="center">부  칙</p>
               <p class="accessTextTitle">제 1 조 (시행일)</p>
                이 약관은 2019년 4월 1일부터 시행한다.   

            </div>

   
          <input type="checkbox" name="req" id=agree class="checkbox"><label for="agree" class="checkLabel"><span id=agree>이용약관에 동의합니다.</span></label><p>
          <input type="button" value="동의" class=agreeBtn onclick="check()"> 
           <input type="reset" value="비동의" class=agreeBtn onclick="noCheck()">
      </form>
   </div>
   
   <script type="text/javascript">
      function check(){
         let req = document.form.req.checked;
         let num = 0;
         ...
         if(num == 1){
            ...
            alert("회원가입을 하시려면 이용약관에 동의하셔야 합니다.");
         }
      }
